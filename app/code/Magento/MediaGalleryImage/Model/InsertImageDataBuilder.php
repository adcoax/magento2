...
use Magento\MediaGalleryImage\Model\InsertImageDataFactory;

/**
 * Build InsertImageData object
 */
class InsertImageDataBuilder
{
    /**
     * @var ReadInterface
     */
     ...
     *
     * @param InsertImageHtml $insertImageHtml
    ...
    public function __construct(
        InsertImageHtml $insertImageHtml,
        Filesystem $fileSystem,
        Mime $mime,
        InsertImageDataFactory $insertImageDataFactory,
        Images $imagesHelper
    ) {
        $this->insertImageHtml = $insertImageHtml;
    ...
    public function execute(
        ...
        $content = $this->insertImageHtml->execute(
            $encodedFilename,
            $forceStaticPath,
            $renderAsTag,
            $storeId
